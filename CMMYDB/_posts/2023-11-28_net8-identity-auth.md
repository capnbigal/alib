...
[Configure.Auth.cs](https://github.com/NetCoreTemplates/blazor/blob/main/CMMYDB/Configure.Auth.cs):
...
[CustomUserSession.cs](https://github.com/NetCoreTemplates/blazor/blob/main/CMMYDB.ServiceInterface/Data/CustomUserSession.cs), e.g:
...
for a new Blazor Project from its [Program.cs](https://github.com/NetCoreTemplates/blazor/blob/main/CMMYDB/Program.cs):
...
configuration in its [Program.cs](https://github.com/NetCoreTemplates/mvc/blob/main/CMMYDB/Program.cs) which will 
also require adding the NuGet dependencies of the OAuth providers you want to support which you can get from its
[CMMYDB.csproj](https://github.com/NetCoreTemplates/mvc/blob/main/CMMYDB/CMMYDB.csproj)
...
UI Pages are in the 
[Components/Identity](https://github.com/NetCoreTemplates/blazor/tree/main/CMMYDB/Components/Identity) and 
[Pages/Account](https://github.com/NetCoreTemplates/blazor/tree/main/CMMYDB/Components/Pages/Account) folders.

For MVC, most of the Identity UI are in the 
[Account](https://github.com/NetCoreTemplates/mvc/blob/main/CMMYDB/Controllers/AccountController.cs)
and [Manage](https://github.com/NetCoreTemplates/mvc/blob/main/CMMYDB/Controllers/ManageController.cs) controllers
as well as their
[Views/Account](https://github.com/NetCoreTemplates/mvc/tree/main/CMMYDB/Views/Account) and
[Views/Manage](https://github.com/NetCoreTemplates/mvc/tree/main/CMMYDB/Views/Manage) folders.
...
[Configure.Mq.cs](https://github.com/NetCoreTemplates/blazor/blob/main/CMMYDB/Configure.Mq.cs)
which uses it to invoke the `SendEmail` API in 
[EmailServices](https://github.com/NetCoreTemplates/blazor/blob/main/CMMYDB.ServiceInterface/EmailServices.cs) in a 
